...
Para forks u otros consumidores que quieran extraer los Parquet automaticamente
desde los releases, en `examples/consumer-repo/` hay un script de descarga
(`download_data.sh`) y un workflow de sincronizacion (`sync-data.yml`) listos
para copiarse. Ver [examples/consumer-repo/README.md](examples/consumer-repo/README.md).

> Si eres mantenedor del proyecto y quieres configurar la sincronizacion
> automatica al repo de analisis, ver [docs/MAINTAINERS.md](docs/MAINTAINERS.md).
